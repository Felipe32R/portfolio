...
export function Project({ title, description, tags, link }: ProjectProps) {
  ...
  return (
    <div
      className="flex flex-col justify-between p-4 max-w-[240px] min-w-[160px] w-full h-[160px] bg-stone-800 cursor-pointer rounded-md transition-all ease-in duration-200  relative
